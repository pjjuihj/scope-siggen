# SCOPE-SIGGEN 实现计划 (v2)

**项目名称**: SCOPE-SIGGEN（示波器/信号发生器）  
**版本**: 2.0.0  
**日期**: 2026-06-26  
**状态**: 待执行  
**更新说明**: 根据审查结果补充遗漏任务、调整时间估算、完善风险评估
...
| TIM5_IRQn | 6 | 0 | DAC触发 |
| TIM8_UP_TIM13_IRQn | 6 | 0 | ADC触发 |
| USART1_IRQn | 7 | 0 | UART接收 |
| I2C1_EV_IRQn | 8 | 0 | I2C事件 |
| I2C1_ER_IRQn | 8 | 0 | I2C错误 |
| EXTI0_IRQn | 9 | 0 | 按键中断 |
...
**第0.5天 (4小时)**:
- 上午: 环境准备（CubeMX、FreeRTOS、中断优先级、启动文件、链接脚本）
